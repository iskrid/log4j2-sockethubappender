...
/**
 * A <code>LoggerRepository</code> is used to create and retrieve <code>Loggers</code>. The relation between loggers in
 * a repository
...
public interface LoggerRepository {
   ...
   * level. The answer depends on the repository threshold and the <code>level</code> parameter. See also
   * {@link #setThreshold} method.
