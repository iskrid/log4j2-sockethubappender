...
public class PropertySetter {
   ...
   * <p>
   * If the setter expects a String no conversion is necessary. If it expects an int, then an attempt is made to convert
   * 'value' to an int using new Integer(value). If the setter expects a boolean, the conversion is by new
   * Boolean(value).
   ...
   * go. The <code>properties</code> are parsed relative to a <code>prefix</code>.
