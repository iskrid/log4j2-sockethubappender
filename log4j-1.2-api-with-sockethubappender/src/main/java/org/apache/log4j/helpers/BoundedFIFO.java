...
public class BoundedFIFO {
   ...
   * guaranteed to be in the range 0 to <code>maxSize</code> (inclusive).
   */
  public int length() {
    return numElements;
  }
   ...
   * buffer. In other words, if there were no elements before the last {@link #put} operation completed.
   */
   ...
   * buffer plus 1 equals the maximum buffer size, returns <code>false</code> otherwise.
   */
