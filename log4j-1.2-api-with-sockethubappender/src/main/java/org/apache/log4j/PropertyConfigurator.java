...
public class PropertyConfigurator {
   ...
   * modified. The period is determined by the <code>delay</code> argument. If a change or file creation is detected,
   * then <code>configFilename</code> is read to configure log4j.
   * @param configFilename A file in key=value format.
